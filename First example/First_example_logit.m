...
% lbi is implemented to recover a linear model with l1 sparsity
% sparsity under logit model. Including computation of auc, visualization of roc 
% and regularization solution path.
%% Setting %%
run ../exp_simulation/Logit_setting_sim.m;
rng(1);
X = randn(n,p);
